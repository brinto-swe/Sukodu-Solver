...
class GUI(STYLE):
        ...
        for i in range(9):
            ...
            for j in range(9):
                ...
                entry = tk.Entry(
                    ...
                    width=2,
                    font=("Helvetica", 30),
                    bg="lightyellow",  # Changed background color
                    fg="blue",         # Changed text color
                    relief="ridge",
                    validate ="key",
    ...
    def right_side_option_block(self):
        ...
        right_block_frame = tk.Frame(self._master,bg="lightblue")  # Changed background color
        ...
        # |           SUDOKU             |
        # +------------------------------+
        title_frame = tk.Frame(right_block_frame,bg="lightblue")  # Changed background color
        
        # "SUDOKU" Title 
        title = tk.Label(title_frame, 
            text="SUDOKU", 
            fg = "white",            # Changed text color
            bg = "lightblue",        # Changed background color
            font = ("Arial", 16))    # Changed font
        ...
        option_frame = tk.Frame(right_block_frame,bg="lightblue")  # Changed background color
        

        # {1-2-1} New Game LabelFrame = [ Easy, Medium, Hard ]
        # +------------------------------+
        # |          NEW Game            |
        # +------------------------------+
        new_game_label_frame = tk.LabelFrame(option_frame,text="  NEW GAME ", bg="lightblue")  # Changed background color
        self.Option_Frame_Add_Style(new_game_label_frame)

        easy_game = tk.Button(new_game_label_frame, text = "Easy", command= lambda : self.easy_medium_hard_game_button_action(41), bg="lightgreen")  # Changed background color
        ...
        medium_game = tk.Button(new_game_label_frame, text = "Medium", command= lambda : self.easy_medium_hard_game_button_action(49), bg="orange")  # Changed background color
        self.Option_Button_Add_Style(medium_game)
        medium_game.grid(row=0,column=1, padx=self.Option_Button_padx, pady=self.Option_Button_pady)

        hard_game = tk.Button(new_game_label_frame, text = "Hard", command= lambda : self.easy_medium_hard_game_button_action(56), bg="red")  # Changed background color
        self.Option_Button_Add_Style(hard_game)
        hard_game.grid(row=0,column=2, padx=self.Option_Button_padx, pady=self.Option_Button_pady)
        ...
        # |            CLEAR             |
        # +------------------------------+
        clear_label_frame = tk.LabelFrame(option_frame, text="  CLEAR  ", bg="lightblue")  # Changed background color
        self.Option_Frame_Add_Style(clear_label_frame)

        restart_game = tk.Button(clear_label_frame, text="Restart", command=self.restart_button_action, bg="lightcoral")  # Changed background color
        ...
        clear_all_game = tk.Button(clear_label_frame, text = "Clear All", command=self.clear_all_button_action, bg="lightpink")  # Changed background color
        ...
        # |             HELP             |
        # +------------------------------+
        help_label_frame = tk.LabelFrame(option_frame, text="  HELP  ", bg="lightblue")  # Changed background color
        self.Option_Frame_Add_Style(help_label_frame)

        hint_b = tk.Button(help_label_frame, text="Hint", command=self.hint_button_action, bg="lightgreen")  # Changed background color
        self.Option_Button_Add_Style(hint_b)
        hint_b.grid(row=0,column=0, padx=self.Option_Button_padx, pady=self.Option_Button_pady)

        self.bot_b = tk.Button(help_label_frame, text = "Bot", command=self.bot_button_action, bg="lightcoral")  # Changed background color
        ...
        # {1-2-4} Save LabelFrame = [ Save Problem ]
        # +------------------------------+
        # |         SAVE PROBLEM         |
        # +------------------------------+
        # {1-2-5} Load LabelFrame = [ Load Problem ]
        # +------------------------------+
        # |         LOAD PROBLEM         |
        # +------------------------------+
        save_label_frame = tk.LabelFrame(option_frame, text="  SAVE / LOAD PROBLEM  ", bg="lightblue")  # Changed background color
        self.Option_Frame_Add_Style(save_label_frame)

        save_button = tk.Button(save_label_frame, text="Save", command=self.save_problem_to_file, bg="lightgreen")  # Changed background color
        self.Option_Button_Add_Style(save_button)
        save_button.grid(row=0, column=0, padx=self.Option_Button_padx, pady=self.Option_Button_pady)

        load_button = tk.Button(save_label_frame, text="Load", command=self.load_problem_from_file, bg="lightcoral")  # Changed background color
        self.Option_Button_Add_Style(load_button)
        load_button.grid(row=0, column=1, padx=self.Option_Button_padx, pady=self.Option_Button_pady)

        save_label_frame.grid(row=4, column=0, pady=self.Option_Frame_pady)
        ## {1-2-4}
    ...
    # +----------------------------------+
    # |      Easy, Medium, Hard Game Action      |
    # +----------------------------------+
    def easy_medium_hard_game_button_action(self,dif):
        if not self.running:
    ...
    def load_problem_from_file(self):
        ...
        if file_path:
            with open(file_path, "r") as file:
                ...
                # update Game_board with the loaded problem
                self.Game_board = np.array(problem)
                
                # clear the current entries
                clear_all_board(self.Game_board, self.Entry_list)
                
                # insert the loaded problem into the GUI
                update_board(self.Game_board, self.Entry_list)
                
                # update is_clear flag
                self.is_clear = False
                # clear Entry_Queue
                self.Entry_Queue.clear()
...
# Generate the Sudoku board GUI
app.generate_sudoku_board()

# Create the right side option block
app.right_side_option_block()
